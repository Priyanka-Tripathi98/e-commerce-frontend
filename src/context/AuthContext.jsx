...
export const AuthProvider = ({ children }) => {
    ...
    const fetchUser = async (authToken) => {
        try {
            const res = await axios.get('https://e-commerce-backend-1wch.onrender.com/profile', {
                headers: {
    ...
    const login = async (email, password) => {
        try {
            const res = await axios.post('https://e-commerce-backend-1wch.onrender.com/login', {
                email,
                password
            });
